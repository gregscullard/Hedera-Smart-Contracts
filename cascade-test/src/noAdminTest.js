...
async function main() {
    ...
    const tokenId = await createToken(client, bobAccountId, DelegateContractId.fromString(proxyContractId.toString()))
    ...
    try {
        await executeContract(client, proxyContractId, 50000,"mintCall", functionParameters, undefined);
    ...
    try {
        await executeContract(client, proxyContractId, 50000,"mintDelegate", functionParameters, undefined);
        console.log(`-- Minting was successful`);
    } catch (e) {
        console.error(e);
    }
